...
def check_file_exists(filepath: str) -> bool:
    ...
    exists = (BACKEND_ROOT / filepath).exists()
...
def main():
    ...
    if all_files_exist and all_modules_installed:
        ...
        print("   cd backend && uvicorn app.api.main:app --reload --port 8000")
        print("\n3. Test in browser:")
        ...
        if not all_modules_installed:
            ...
            print("   pip install -r backend/requirements/requirements-api.txt")
