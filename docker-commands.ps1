...
Development:
  ...
  .\docker-commands.ps1 dev-logs         - Show development logs
  .\docker-commands.ps1 dev-stop         - Stop development environment

Production:
  .\docker-commands.ps1 prod             - Start production environment
  .\docker-commands.ps1 prod-stop        - Stop production environment

Building:
  .\docker-commands.ps1 build            - Build all Docker images

Utilities:
  .\docker-commands.ps1 shell-backend    - Access backend shell
  .\docker-commands.ps1 shell-frontend   - Access frontend shell
  .\docker-commands.ps1 logs             - Show all logs
  .\docker-commands.ps1 status           - Show container status
  .\docker-commands.ps1 env-setup        - Create .env file
  .\docker-commands.ps1 clean            - Stop and remove all containers/volumes
"@
}
